...
import { getIntialState, scrambledWordReducer } from './reducer/scrambledWordReducer';

export const ScrambleWords = () => {
  const [ state, dispatch ] = useReducer( scrambledWordReducer, getIntialState() )
  ...
  return (
    <div className="w-full min-h-screen bg-linear-to-br from-purple-100 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md mx-auto">
        ...
        {/* Main Game Card */}
        <Card className="backdrop-blur-sm bg-white/80 border-0 shadow-xl py-0">
